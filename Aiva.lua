...
if hash or SudoBot(msg) or DevLARVINW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevLARVINW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevLARVINW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "SourceLarvine")
...
--------------------------------------------------------------------------------------------------------------
function SourceLARVIN(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."LARVIN1:List:Filter"..sl)
...
if not DevLARVINW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevLARVINW(msg) and msg.reply_to_message_id_ ~= 0  then
...
if text == 'تفعيل التواصل ⌔' and DevLARVINW(msg) then  
...
if text == 'تعطيل التواصل ⌔' and DevLARVINW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌔' and DevLARVINW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌔' and DevLARVINW(msg) then  
...
if text == 'الاصدار ⌔' and DevLARVINW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌔︙اصدار سورس لارفين* \n*⌔︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ⌔' and DevLARVINW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌔︙[تحديثات البوت](t.me/i600ik) \n⌔︙[قناه السورس](t.me/SourceLarvine)')
end
if text == "ضع اسم للبوت ⌔" and DevLARVINW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌔︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌔' and DevLARVINW(msg) then 
...
if text == 'المشتركين ⌔' and DevLARVINW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌔︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌔' and DevLARVINW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌔︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌔") and DevLARVINW(msg) then
...
if text == ("قائمه العام ⌔") and DevLARVINW(msg) then
...
if text == ("قائمه الكتم العام ⌔") and DevLARVINW(msg) then
...
if text=="اذاعه خاص ⌔" and msg.reply_to_message_id_ == 0 and DevLARVINW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌔︙ارسل الان اذاعتك؟* \n*⌔︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌔" and msg.reply_to_message_id_ == 0 and DevLARVINW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌔︙ارسل الان اذاعتك؟* \n*⌔︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌔" and msg.reply_to_message_id_ == 0 and DevLARVINW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌔︙ارسل الان اذاعتك؟* \n*⌔︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌔" and msg.reply_to_message_id_ == 0  and DevLARVINW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌔︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌔" and msg.reply_to_message_id_ == 0  and DevLARVINW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌔︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌔' and DevLARVINW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌔" and DevLARVINW(msg) then
...
if text == "تنظيف الكروبات ⌔" and DevLARVINW(msg) then 
...
if text and text:match("^رفع مطور @(.*)$") and DevLARVINW(msg) then
...
usertext = '*\n ⌔︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'SourceLarvine')..')'
status  = '\n *⌔︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevLARVINW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌔︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'SourceLarvine')..')'
status  = '\n*⌔︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevLARVINW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevLARVINW(msg) then
...
if LARVIN1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌔︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SourceLarvine')..') \n ⌔︙'..LARVIN1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevLARVINW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevLARVINW(msg) then
...
os.execute('wget https://raw.githubusercontent.com/LARVINNTEAM/LARVIN/main/LARVIN.lua')
send(msg.chat_id_, msg.id_,' *⌔︙تم تحديث السورس* \n*⌔︙لديك اخر اصدار لسورس ايفا*\n*⌔︙الاصدار » { 2.8v}*')
dofile('LARVIN.lua')  
end
if text and text:match("^تغير الاشتراك$") and DevLARVINW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌔︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevLARVINW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌔︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌔" and DevLARVINW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌔︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌔$") and DevLARVINW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌔︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌔" and DevLARVINW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ⌔" and DevLARVINW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌔︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌔" and DevLARVINW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."LARVIN:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."LARVIN:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_LARVIN = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_LARVIN then 
names_LARVIN = database:smembers(bot_id.."LARVIN:blocname"..msg.chat_id_) or ""
if names_LARVIN and names_LARVIN[1] then 
for i=1,#names_LARVIN do 
if name_LARVIN:match("(.*)("..names_LARVIN[i]..")(.*)") then 
...
database:set(bot_id.."LARVIN:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."LARVIN:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."LARVIN:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."LARVIN:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."LARVIN:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_LARVINa_new(LARVIN1,LARVIN2)
if LARVIN2 and LARVIN2.first_name_ then 
if LARVIN2.first_name_:match("(.*)"..database:get(bot_id.."LARVIN:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."LARVIN:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local LARVIN_nnn = database:get(bot_id.."LARVIN:nump"..msg.chat_id_) or 5
local LARVIN_nnn2 = database:get(bot_id.."LARVIN:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(LARVIN_nnn2) == tonumber(LARVIN_nnn) or tonumber(LARVIN_nnn2) > tonumber(LARVIN_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."LARVIN:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌔︙عزيزي >>["..LARVIN2.username_.."](https://t.me/"..(LARVIN2.username_ or "SourceLarvine")..")\n⌔︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."LARVIN:teh"..msg.chat_id_).."} بجانب اسمك\n⌔︙عدد المحاولات المتبقيه {"..(tonumber(LARVIN_nnn) - tonumber(LARVIN_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_LARVINa_new)
end
end
...
local LARVINChengName = database:get(bot_id.."LARVIN:Cheng:Name"..data.id_)
if not data.first_name_ then 
if LARVINChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..LARVINChengName..']')
database:del(bot_id.."LARVIN:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if LARVINChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."LARVIN:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if text == 'رفع نسخه الاحتياطيه' and DevLARVINW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevLARVINW(msg) then
dofile('LARVIN.lua')  
send(msg.chat_id_, msg.id_, ' *⌔︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevLARVINW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevLARVINW(msg) then  
function start_function(extra, result, success)
if LARVINSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevLARVINW(msg) then  
...
if LARVINSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*⌔︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevLARVINW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if LARVINSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*⌔︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevLARVINW(msg) then  
function start_function(extra, result, success)
if LARVINSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*⌔︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevLARVINW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevLARVINW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if LARVINSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*⌔︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevLARVINW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevLARVINW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevLARVINW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevLARVINW(msg) then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevLARVINW(msg) then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevLARVINW(msg) then
...
if text == "مسح الملفات" and DevLARVINW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌔︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevLARVINW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevLARVINW(msg) then  
function start_function(extra, result, success)
...
local UserName = (b.username_ or "SourceLarvine")
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_LARVIN, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_LARVIN, nil)
return false 
end
...
if text == 'مسح كليشه المطور' and DevLARVINW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌔︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevLARVINW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⌔︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'SourceLarvine')..')'..'\n*⌔︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevLARVINW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevLARVINW(msg) then  
...
if database:get(bot_id..'Bc:Bots') and not DevLARVINW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,LARVIN)
local t = "\n*ツ قائمة الاعضاء* \n*ٴ┉ ┉ ┉ ┉ ┉ 𝑳𝐍 ┉  ┉ ┉ ┉ ┉ٴ*\n"
x = 0
...
if LARVINSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevLARVINW(msg) then 
...
if text == ("ردود المطور") and DevLARVINW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌔︙قائمة ردود المطور \n*ٴ┉ ┉ ┉ ┉ ┉ 𝑳𝐍 ┉  ┉ ┉ ┉ ┉ٴ*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevLARVINW(msg) then    
send(msg.chat_id_, msg.id_,' *⌔︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevLARVINW(msg) then    
...
if text == 'تفعيل المغادره' and DevLARVINW(msg) then   
...
if text == 'تعطيل المغادره' and DevLARVINW(msg) then  
...
if text == 'استعاده الاوامر' and DevLARVINW(msg) then
...
{{text = '彡 𝑳𝐀𝐑𝐕𝐈𝐍 𝐓𝐄𝐀𝐌 ➢', url="t.me/huer44"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = '彡 𝑳𝐀𝐑𝐕𝐈𝐍 𝐓𝐄𝐀𝐌 ➢', url="t.me/huer44"}},
{{text = 'مطور السورس', url="t.me/TTITITl"}},
}
...
inline = {
{{text = 'sᴏᴜʀᴄʀ ʟᴀʀᴠɪɴ',url='http://t.me/huer44'}},
}
